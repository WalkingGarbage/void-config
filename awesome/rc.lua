...
globalkeys = gears.table.join(
    ...
    -- Browser incognito
    awful.key({ modkey, altkey },      "F1",     function ()
    awful.util.spawn("firefox --args -private-window")
    end,
              {description = "firefox private", group = "internet"}),
    ...
    awful.util.spawn("whatsapp-nativefier")
              ...
              {description = "whatsapp", group = "apps"}),
    ...
    -- Restart system
    awful.key({ "Ctrl", altkey },     "r",     function ()
...
clientkeys = gears.table.join(
    ...
    awful.key({ modkey, "Shift" }, "s",  awful.client.floating.toggle                     ,
...
-- AUTOSTART
awful.spawn.with_shell("xrandr --output DisplayPort-0 --primary --mode 2560x1440 --pos 1920x0 --rotate normal --set TearFree on --output HDMI-A-0 --mode 1920x1080 --pos 0x360 --rotate normal --set TearFree on")
